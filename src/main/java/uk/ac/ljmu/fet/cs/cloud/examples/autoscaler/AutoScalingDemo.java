...
public class AutoScalingDemo implements TraceExhaustionCallback {
	...
	/** The Queue Manager for handling all the kinds waiting to be executed */
	...
	public void simulateAndprintStatistics() {
		...
		//System.out.println("Number of waiting jobs :" + VMOptimisationBasedVI.loadAvailablesJobs()+"s" );
	}
